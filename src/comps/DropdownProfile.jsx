    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-[14px] font-montserrat font-semibold text-aspide-blue group-hover:text-dark-aspide">Acme Inc.</span>
          <svg className="w-3 h-3 shrink-0 ml-1 fill-current text-light-aspide" viewBox="0 0 12 12">
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-slate-700">
            <div className="font-medium text-aspide-blue">Acme Inc.</div>
