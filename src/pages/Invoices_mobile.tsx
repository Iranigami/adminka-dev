...
export default function Invoices_mobile() {
  const clearToken = () => {
  ...
  return (
    <Col className={'transactions-view w-full h-full min-w-full min-h-fill'}>
              <Card className={'mt-[4vw]'}>
        <Col className={'w-full justify-center'}>
          <Row className={'w-full'}>

          </Row>

          <Row className={'w-full mt-[4vw]'}>
            <Col className={'h-full justify-center'}>
              <Row className={'gap-[4vw]'}>
                <Select
                  className={'mt-[1vw] flex flex-col h-full justify-center w-[25vw] text-[2.5vw]'}
                ...
                <Col className={'h-full justify-center'}>
                  <Row className={'gap-[4vw] w-[100vw]'}>
                    <DateInput
                      className='w-[25vw] text-[3.5vw]'
                      value={fromDate}
                      onChange={e => {
                    ...
                    <DateInput
                      className='w-[25vw] text-[3.5vw] -ml-[19vw]'
                      value={toDate}
                      onChange={e => {
                        const input: HTMLInputElement = e.target as HTMLInputElement;
                  ...
                  <button
                    disabled={isRequesting}
                    className={"w-[40vw] h-[10vw] bg-aspide-blue rounded-[8vw] text-very-white mx-0 mt-[2vw]"}
                    onClick={() => {
                      fetchInvoices();
                    }}
                  >
